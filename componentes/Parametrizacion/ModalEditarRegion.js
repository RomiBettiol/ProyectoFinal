...
const ModalEditarRegion = ({ isVisible, onClose, onEdit, editingRegion, onSuccessUpdate, onErrorUpdate  }) => {
  const [regionName, setRegionName] = useState('');

  const handleEditRegion = () => {
    axios
      .put(`https://romibettiol.loca.lt/parameters/region/${editingRegion.idRegion}`, {
      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <View style={[{ flexDirection: 'row' }, styles.botonesDecidir]}>
            <TouchableOpacity style={styles.botonesEditar} onPress={handleEditRegion}>
              <Text>Editar</Text>
            </TouchableOpacity>
