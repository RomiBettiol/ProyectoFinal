...
export default function AltaTurno({ visible, onClose  }) {
    ...
    const data = {
      ...
      vaccineDate: `2024-11-11 10:10:00`,
    ...
    useEffect(() => {
      ...
      if (horaValida && fechaValida) {
        ...
        if (!fechaValida) {
          ...
          errorMessage += "La fecha debe ser igual o mayor a la fecha actual, con mes entre 1 y 12 y días válidos.";
        }
