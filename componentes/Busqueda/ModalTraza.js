  ...
  const fetchTraces = async () => {
    try {
      const response = await axios.get(
        `https://37e1-186-12-32-189.ngrok-free.app/publications/trace/${idPublicationSearch}`,
        {
          headers: {
            "auth-token": token,
          },
  ...
  const onDeleteTrace = async () => {
    ...
    try {
      const response = await axios.delete(
        `https://37e1-186-12-32-189.ngrok-free.app/publications/trace/${selectedTrace.idTrace}`,
        {
          headers: {
            "auth-token": token,
          },
    ...
    if (locationToSend) {
      ...
      try {
        ...
        const response = await axios.post(
          "https://37e1-186-12-32-189.ngrok-free.app/publications/trace/",
          data,
          {
            headers: {
