...
const FormularioRegistrarse = ({
  ...
  const [fechaNacimiento, setFechaNacimiento] = useState(datosFormulario.fechaNacimiento);
  ...
  }, [nombre,apellidos, email, usuario, contrasena, contrasena2, image, domicilio, nroTelefono, fechaNacimiento, cuitCuil, onDatosChange]);
