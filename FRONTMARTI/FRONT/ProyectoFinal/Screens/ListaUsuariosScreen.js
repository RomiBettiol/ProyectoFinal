...
const ListaUsuariosScreen = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        "https://8396-191-82-3-33.ngrok-free.app/security/user/every",
        config
      );
  ...
  const handleModifyRole = async (selectedRole) => {
    try {
      ...
      await axios.post(
        `https://8396-191-82-3-33.ngrok-free.app/security/user/changeRole/${userId}/${selectedRole}`,
        {},
        config
      );
    ...
    try {
      ...
      if (userState === "ACTIVO") {
        response = await axios.delete(
          `https://8396-191-82-3-33.ngrok-free.app/security/user/${userId}`,
          config
        );
      } else {
        response = await axios.post(
          `https://8396-191-82-3-33.ngrok-free.app/security/user/changeState/${userId}/ACTIVO`,
          {},
          config
        );
      }
