...
export default function MisVacunas(token) {
    ...
    const [error404, setError404] = useState(false);
        ...
        async function fetchVaccines() {
            try {
                const response = await axios.get(`https://8396-191-82-3-33.ngrok-free.app/mypet/vaccine/${mascotaId}`);
    ...
    const handleDeleteVaccin = async () => {
        ...
        try {
            const response = await axios.delete(`https://8396-191-82-3-33.ngrok-free.app/mypet/vaccine/${mascotaId}/${vaccin.idVaccine}`);
