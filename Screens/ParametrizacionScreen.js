...
export default function ParametrizacionScreen({ navigation }) {
  ...
  const getZonas = () => {
    axios
      .get("  https://2f6b-181-91-230-36.ngrok-free.app/parameters/locality/", {
        headers: {
  ...
  const getPetColors = () => {
    axios
      .get("  https://2f6b-181-91-230-36.ngrok-free.app/parameters/petColor/")
      .then((response) => {
  ...
  const getPetTypes = () => {
    axios
      .get("  https://2f6b-181-91-230-36.ngrok-free.app/parameters/petType/")
      .then((response) => {
  ...
  const getPetBreeds = () => {
    axios
      .get("  https://2f6b-181-91-230-36.ngrok-free.app/parameters/petBreed/")
      .then((response) => {
  ...
  const getProvinces = () => {
    axios
      .get("  https://2f6b-181-91-230-36.ngrok-free.app/parameters/province/")
      .then((response) => {
  ...
  const getRegions = () => {
    axios
      .get("  https://2f6b-181-91-230-36.ngrok-free.app/parameters/region/")
      .then((response) => {
