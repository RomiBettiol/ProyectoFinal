...
export default function ParametrizacionScreen({ navigation }) {
  ...
  const handleAddProvince = (newProvinceName) => {
    ...
    axios
      .post(
        ` https://e860-181-91-230-36.ngrok-free.app/parameters/province/`,
        newProvince
      )
      .then((response) => {
  ...
  const handleAddType = (newTypeName) => {
    ...
    axios
      .post(
        ` https://e860-181-91-230-36.ngrok-free.app/parameters/petType/`,
        newType
      )
      .then((response) => {
  ...
  const handleAddColor = (newColorName) => {
    ...
    axios
      .post(
        ` https://e860-181-91-230-36.ngrok-free.app/parameters/petColor/`,
        newColor
      )
      .then((response) => {
  ...
  const handleZoneDelete = (zoneId) => {
    axios
      .delete(
        ` https://e860-181-91-230-36.ngrok-free.app/parameters/locality/${zoneId}`
      )
      .then((response) => {
  ...
  const handleBreedDelete = (breedId) => {
    axios
      .delete(
        ` https://e860-181-91-230-36.ngrok-free.app/parameters/petBreed/${breedId}`
      )
      .then((response) => {
        handleSuccessfulDeletePublication();
        getPetBreeds();
  ...
  const handleColorDelete = (colorId) => {
    axios
      .delete(
        ` https://e860-181-91-230-36.ngrok-free.app/parameters/petColor/${colorId}`
      )
      .then((response) => {
        handleSuccessfulDeletePublication();
        getPetColors();
  ...
  const handleTypeDelete = (typeId) => {
    axios
      .delete(
        ` https://e860-181-91-230-36.ngrok-free.app/parameters/petType/${typeId}`
      )
      .then((response) => {
        handleSuccessfulDeletePublication();
        getPetTypes();
  ...
  const handleProvinceDelete = (provinceId) => {
    axios
      .delete(
        ` https://e860-181-91-230-36.ngrok-free.app/parameters/province/${provinceId}`
      )
      .then((response) => {
        handleSuccessfulDeletePublication();
        getProvinces();
  ...
  const handleRegionDelete = (regionId) => {
    axios
      .delete(
        ` https://e860-181-91-230-36.ngrok-free.app/parameters/region/${regionId}`
      )
      .then((response) => {
        handleSuccessfulDeletePublication();
        getRegions();
  ...
  const getRegions = () => {
    axios
      .get(` https://e860-181-91-230-36.ngrok-free.app/parameters/region/`)
      .then((response) => {
