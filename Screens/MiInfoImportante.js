  ...
  async function fetchInformacion() {
    try {
      const response = await axios.get(
        ` https://6557-181-91-230-36.ngrok-free.app/mypet/information/${mascotaId}`
      );
  ...
  const handleDeleteInfo = async () => {
    ...
    try {
      const response = await axios.delete(
        ` https://6557-181-91-230-36.ngrok-free.app/mypet/information/${mascotaId}/${info.idInformation}`
      );
