  ...
  const fetchData = async () => {
    try {
      ...
      const rolesResponse = await axios.get(
        "https://8396-191-82-3-33.ngrok-free.app/security/role/every",
        config
      );

      const permisosResponse = await axios.get(
        "https://8396-191-82-3-33.ngrok-free.app/security/permission/",
        config
      );
    ...
    try {
      ...
      if (state === "ACTIVO") {
        response = await axios.delete(
          `https://8396-191-82-3-33.ngrok-free.app/security/${type}/${id}`,
          config
        );
      } else {
        response = await axios.post(
          `https://8396-191-82-3-33.ngrok-free.app/security/${type}/active/${id}`,
          {},
          config
        );
      }
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      if (type === "role") {
        ...
        response = await axios.post(
          `https://8396-191-82-3-33.ngrok-free.app/security/${type}/`,
          data,
          config
        );
      } else {
  ...
  const managePermission = async (idPermission, tokenClaim) => {
    ...
    try {
      ...
      if (permissionRole.includes(tokenClaim)) {
        response = await axios.delete(
          `https://8396-191-82-3-33.ngrok-free.app/security/role/take/${id}/${idPermission}`,
          config
        );
      } else {
        response = await axios.post(
          `https://8396-191-82-3-33.ngrok-free.app/security/role/add/${id}`,
          data,
          config
        );
      }
