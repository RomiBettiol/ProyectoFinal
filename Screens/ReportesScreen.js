...
export default function ReportesScreen() {
    ...
    useEffect(() => {
        ...
        axios.get('http://buddy-app1.loca.lt/reports/count/founds-success')
          .then((response) => {
        ...
        // Servicios activos
        axios.get('http://buddy-app1.loca.lt/reports/count/services-actives')
        .then((response) => {
          // Extraer el valor quantity de la respuesta
          const { quantity } = response.data;
        ...
        // Usuarios activos
        axios.get('http://buddy-app1.loca.lt/reports/count/users-actives')
        .then((response) => {
          // Extraer el valor quantity de la respuesta
          const { quantity } = response.data;
        ...
        // Mascotas perdidas
        axios.get('http://buddy-app1.loca.lt/reports/count/losts-actives')
        .then((response) => {
          // Extraer el valor quantity de la respuesta
          const { quantity } = response.data;
        ...
        axios.get('http://buddy-app1.loca.lt/reports/count/adoptions-actives')
        .then((response) => {
          // Extraer el valor quantity de la respuesta
          const { quantity } = response.data;
        ...
        // Mascotas adoptadas
        axios.get('http://buddy-app1.loca.lt/reports/count/adoptions-success')
        .then((response) => {
          // Extraer el valor quantity de la respuesta
          const { quantity } = response.data;
