...
export default function ReportesScreen() {
  ...
  useEffect(async () => {
    ...
    axios
      .get(
        ` https://6557-181-91-230-36.ngrok-free.app/reports/count/services-actives`
      )
      .then((response) => {
        // Extraer el valor quantity de la respuesta
        const { quantity } = response.data;
    ...
    axios
      .get(
        ` https://6557-181-91-230-36.ngrok-free.app/reports/count/users-actives`
      )
      .then((response) => {
        // Extraer el valor quantity de la respuesta
        const { quantity } = response.data;
    ...
    axios
      .get(
        ` https://6557-181-91-230-36.ngrok-free.app/reports/count/adoptions-actives`
      )
      .then((response) => {
        // Extraer el valor quantity de la respuesta
        const { quantity } = response.data;
