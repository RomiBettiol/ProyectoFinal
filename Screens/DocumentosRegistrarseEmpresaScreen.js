...
export default function DocumentosRegistrarseEmpresaScreen({ route }) {
  ...
  console.log('despues de navegar:',checkBoxData, email, isValidEmail, nombre, usuario, contrasena, images)
  ...
  const sendDocData = async (docLink) => {
    ...
    const response = await axios.post('https://buddy-app2.loca.lt/security/user/register', data, config);
