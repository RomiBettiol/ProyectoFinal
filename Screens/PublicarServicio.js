...
import TipoMascota from '../componentes/Serivicios/TipoMascotas';
  ...
  return (
    <View style={styles.container}>
        ...
        <ScrollView style={styles.scroll}>
          ...
          <View style={styles.subcontenedor4}>
            <Text style={styles.tituloPublicacion}>E-mail</Text>
              <TextInput
                ...
                onEndEditing={handleEndEditing}
              />
            {!isEmailValid && <Text style={styles.errorText}>Por favor, escriba un e-mail válido.</Text>}
          </View>
          ...
          <Text style={styles.descripcionPublicacion}>Tipo de mascotas</Text>
          <TipoMascota selectedTypes={selectedTypes} setSelectedTypes={setSelectedTypes} animalId={animalId} />
          <Text style={styles.descripcionPublicacion}>Tipo de servicio</Text>
          <ListaValoresTipoServicios selectedServiceType={selectedServiceType} setSelectedServiceType={setSelectedServiceType} setSelectedServiceTypeId={setSelectedServiceTypeId} />
         ...
         {!isHourValid && <Text style={styles.errorText}>El formato de la hora debe ser HH (0 a 24).</Text>}
         {!isMinuteValid && <Text style={styles.errorText}>El formato de los minutos debe ser MM (0 a 59).</Text>}
        ...
        <Modal transparent={true} visible={isErrorModalVisible}>
          <View style={[styles.modalContainer, styles.errorModalContainer]}>
            <View style={styles.modalContentError}>
              <Text style={styles.modalText}>Error al publicar el servicio. Por favor, inténtalo de nuevo.</Text>
            </View>
          </View>
        </Modal>
        ...
        <Modal transparent={true} visible={isSuccessModalVisible}>
          <View style={[styles.modalContainer, styles.successModalContainer]}>
            <View style={styles.modalContent}>
              <Text style={styles.modalText}>¡El servicio ha sido publicado correctamente!</Text>
            </View>
          </View>
        </Modal>
    </View>
