...
import { StyleSheet,FlatList,ScrollView, Text,TextInput, TouchableOpacity, View,KeyboardAvoidingView,Modal,} from 'react-native';
...
export default function RecuperarContrasenaScreen({}){
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.post('https://buddy-app1.loca.lt/security/auth/resetPassword', {
        mail: email
      });
